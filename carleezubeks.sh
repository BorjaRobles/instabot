...
## Follow clients
python follow_users_from_file.py -u carleezubeks -p insta@123 "$(realpath clients.txt)"
...
echo -e " Like HASTAGS \n"
## Like hastags
  python like_hashtags.py -u carleezubeks -p insta@123 hashtags follow4follow like4like instafollow followme followforfollow followback
  ...
  python auto_post.py -u carleezubeks -p insta@123
